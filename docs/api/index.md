...
| Analytics | `/analytics/gsc`, `/analytics/ga`; extensions may add more via `datamachine_analytics_ability_map` | `manage_flows` via `PermissionHelper::can( 'manage_flows' )`. | `inc/Api/Analytics.php` | [Analytics](endpoints/analytics.md) |
