...
| Analytics | `/analytics/gsc`, `/analytics/bing`, `/analytics/ga` | `manage_flows` via `PermissionHelper::can( 'manage_flows' )`. | `inc/Api/Analytics.php` | [Analytics](endpoints/analytics.md) |
