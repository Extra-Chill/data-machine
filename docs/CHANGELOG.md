...
### Fixed
- refuse a silent cross-filesystem tempnam() fallback in ComposableFileGenerator

## [0.177.3] - 2026-09-23

### Fixed
- bind packet-bound handler tools to sole claim and add model-facing disposition handles
...
### Fixed
- skip ghost plugin entries and drop descriptions in SITE.md Active Plugins
...
### Fixed
- make claim-index migration checks portable
...
### Fixed
- harden dispatcher health evidence
...
### Fixed
- recover pathless child jobs safely
...
### Fixed
- load job liveness classifier correctly ([#2962](https://github.com/Extra-Chill/data-machine/pull/2962)) (by Chris Huber)
...
### Fixed
- record direct tool metadata payloads
...
### Fixed
- honor agents chat runtime controls
...
### Fixed
- split wp ai client cache classes
...
### Fixed
- clean formatting lint blockers

## [0.131.5] - 2026-05-21

### Fixed
- align fetch ability schemas

## [0.131.4] - 2026-05-21

### Fixed
- clean remaining lint blockers
...
### Changed
- deprecate oauth get account context

## [0.130.0] - 2026-05-20

### Added
- add oauth account context resolver
...
### Fixed
- align bundle rebase assignments
...
### Changed
- drop dead scan_and_instantiate + per-request migration callback
