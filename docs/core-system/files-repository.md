...
- **Agent memory primitives** — `AgentMemory`, `WP_Agent_Memory_Store`, `WP_Agent_Memory_Stores`, `DiskAgentMemoryStore`, `WP_Agent_Memory_Scope`, `WP_Agent_Memory_Read_Result`, `WP_Agent_Memory_Write_Result`, `WP_Agent_Memory_List_Entry`, `DailyMemory`, `DailyMemoryStorage`
