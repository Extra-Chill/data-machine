...
$assert( ! is_file( $root . '/vendor/wordpress/agents-api/inc/AI/WpAiClient.php' ), 'Agents API carries no low-level wp-ai-client execution wrapper' );
...
$assert( ! str_contains( $ability, 'datamachine_ai_capability_defaults' ), 'image ability has no Data Machine provider-default hook contract' );
