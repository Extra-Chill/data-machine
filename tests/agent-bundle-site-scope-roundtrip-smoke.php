...
assert_scope_equals( 'numeric strings are not canonical scope values', BundleSchema::SITE_SCOPE_UNSPECIFIED, BundleSchema::normalize_agent_site_scope( '7' ) );
assert_scope_equals( 'string "null" is not canonical network scope', BundleSchema::SITE_SCOPE_UNSPECIFIED, BundleSchema::normalize_agent_site_scope( 'null' ) );
