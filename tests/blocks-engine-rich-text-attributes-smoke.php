...
if ( ! defined( 'ABSPATH' ) || ! function_exists( 'parse_blocks' ) ) {
	...
	$checks         = array(
		...
		'bulk query bypasses site filters'    => false !== strpos( $command_source, "'suppress_filters'       => false" ),
...
assert_blocks_engine_rich_text( 'bulk query inventories posts without site filters', false === $query_args['suppress_filters'] );
