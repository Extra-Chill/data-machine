...
datamachine_pending_actions_assert( str_contains( $plugin_source, "interface_exists( '\\AgentsAPI\\AI\\Approvals\\WP_Agent_Pending_Action_Observer' )" ), 'default WordPress pending-action observer waits for Agents API observer contract', $failures, $passes );
