...
$cli_bootstrap      = datamachine_pending_actions_source( 'inc/Core/Bootstrap/CliServiceProvider.php' );
...
datamachine_pending_actions_assert( str_contains( $resolver_source, 'agents_resolve_pending_action' ), 'Data Machine delegates through canonical Agents API resolution', $failures, $passes );
datamachine_pending_actions_assert( ! str_contains( $resolver_source, "'datamachine/resolve-pending-action'" ) && ! str_contains( $resolver_source, 'execute_legacy_alias' ), 'deprecated resolver alias is not registered', $failures, $passes );
datamachine_pending_actions_assert( str_contains( $plugin_source, 'ResolvePendingActionAbility()' ), 'Data Machine REST resolver adapter remains registered', $failures, $passes );
