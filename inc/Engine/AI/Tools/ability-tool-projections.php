...
if ( ! function_exists( 'datamachine_register_global_ability_tools' ) ) {
	/** Register Data Machine's built-in model-facing ability projections. */
	function datamachine_register_global_ability_tools(): void {
