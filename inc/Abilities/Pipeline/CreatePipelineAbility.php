				...
				array(
					...
					'output_schema'       => array(
						...
						'properties' => array(
							...
							'pipeline_id'   => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
							'pipeline_name' => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
							'flow_id'       => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
							'flow_name'     => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
							'steps_created' => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
							'flow_step_ids' => array( 'anyOf' => array( array( 'type' => 'array' ), array( 'type' => 'null' ) ) ),
							'creation_mode' => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
							'created_count' => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
							'failed_count'  => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
							'created'       => array( 'anyOf' => array( array( 'type' => 'array' ), array( 'type' => 'null' ) ) ),
							'errors'        => array( 'anyOf' => array( array( 'type' => 'array' ), array( 'type' => 'null' ) ) ),
							'partial'       => array( 'anyOf' => array( array( 'type' => 'boolean' ), array( 'type' => 'null' ) ) ),
							'message'       => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
							'error'         => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
						),
					),
