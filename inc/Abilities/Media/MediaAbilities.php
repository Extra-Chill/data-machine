			...
			array(
				...
				'output_schema'       => array(
					...
					'properties' => array(
						...
						'media_id'   => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
		...
		wp_register_ability(
			...
			array(
				...
				'output_schema'       => array(
					...
					'properties' => array(
						'success'   => array( 'type' => 'boolean' ),
						'duration'  => array( 'anyOf' => array( array( 'type' => 'number' ), array( 'type' => 'null' ) ) ),
						'width'     => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
						'height'    => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
						'codec'     => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
						'bitrate'   => array( 'anyOf' => array( array( 'type' => 'integer' ), array( 'type' => 'null' ) ) ),
						'framerate' => array( 'anyOf' => array( array( 'type' => 'number' ), array( 'type' => 'null' ) ) ),
						'mime_type' => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
						'file_size' => array( 'type' => 'integer' ),
						'format'    => array( 'anyOf' => array( array( 'type' => 'string' ), array( 'type' => 'null' ) ) ),
