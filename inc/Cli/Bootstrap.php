...
WP_CLI::add_command( 'datamachine tracked-items', Commands\TrackedItemsCommand::class );
...
WP_CLI::add_command( 'datamachine tracked-item', Commands\TrackedItemsCommand::class );
